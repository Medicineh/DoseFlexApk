...
public final class zzbh implements ServiceConnection {
    ...
    public final synchronized Task<Void> zza(Intent intent) {
        ...
        final ScheduledFuture<?> scheduledFutureSchedule = scheduledExecutorService.schedule(new Runnable(zzbgVar) { // from class: com.google.firebase.iid.zzbj
        ...
        zzbgVar.zza().addOnCompleteListener(scheduledExecutorService, new OnCompleteListener(scheduledFutureSchedule) { // from class: com.google.firebase.iid.zzbi
