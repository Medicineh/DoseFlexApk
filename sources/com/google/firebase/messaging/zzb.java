...
public final class zzb {
    ...
    static zza zza(Context context, zzt zztVar) {
        Uri defaultUri;
        Intent intent;
        PendingIntent activity;
        Bundle bundleZza = zza(context.getPackageManager(), context.getPackageName());
        String packageName = context.getPackageName();
        String strZzb = zzb(context, zztVar.zza("gcm.n.android_channel_id"), bundleZza);
        Resources resources = context.getResources();
        PackageManager packageManager = context.getPackageManager();
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, strZzb);
        String strZza = zztVar.zza(resources, packageName, "gcm.n.title");
        if (!TextUtils.isEmpty(strZza)) {
            builder.setContentTitle(strZza);
        }
        String strZza2 = zztVar.zza(resources, packageName, "gcm.n.body");
        if (!TextUtils.isEmpty(strZza2)) {
            builder.setContentText(strZza2);
            builder.setStyle(new NotificationCompat.BigTextStyle().bigText(strZza2));
        }
        builder.setSmallIcon(zza(packageManager, resources, packageName, zztVar.zza("gcm.n.icon"), bundleZza));
        String strZzb2 = zztVar.zzb();
        Integer num = null;
        ...
        String strZza3 = zztVar.zza("gcm.n.click_action");
        if (TextUtils.isEmpty(strZza3)) {
            Uri uriZza = zztVar.zza();
            if (uriZza != null) {
        ...
        PendingIntent pendingIntentZza = !zztVar.zzb("google.c.a.e") ? null : zza(context, new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS").putExtras(zztVar.zzf()));
        if (pendingIntentZza != null) {
            builder.setDeleteIntent(pendingIntentZza);
        }
        Integer numZza = zza(context, zztVar.zza("gcm.n.color"), bundleZza);
        if (numZza != null) {
        ...
        String strZza4 = zztVar.zza("gcm.n.ticker");
        if (strZza4 != null) {
            builder.setTicker(strZza4);
        }
        Integer numZzc = zztVar.zzc("gcm.n.notification_priority");
        if (numZzc == null) {
            numZzc = null;
        ...
        Integer numZzc2 = zztVar.zzc("gcm.n.visibility");
        if (numZzc2 == null) {
            numZzc2 = null;
        ...
        Integer numZzc3 = zztVar.zzc("gcm.n.notification_count");
        if (numZzc3 != null) {
        ...
        Long lZzd = zztVar.zzd("gcm.n.event_time");
        if (lZzd != null) {
        ...
        int i = zztVar.zzb("gcm.n.default_sound") ? 1 : 0;
        ...
        String strZza5 = zztVar.zza("gcm.n.tag");
        if (TextUtils.isEmpty(strZza5)) {
            long jUptimeMillis = SystemClock.uptimeMillis();
            StringBuilder sb5 = new StringBuilder(37);
            sb5.append("FCM-Notification:");
            sb5.append(jUptimeMillis);
            strZza5 = sb5.toString();
        }
        return new zza(builder, strZza5, 0);
    }
