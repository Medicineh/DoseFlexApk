...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", AppMeasurementSdk.ConditionalUserProperty.NAME, "value"}, sb.toString(), null, null, null, null), SQLiteEventStore$$Lambda$16.lambdaFactory$(map));
        return map;
    }
