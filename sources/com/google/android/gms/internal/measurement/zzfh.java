...
final class zzfh extends zzdt<Float> implements zzfq<Float>, zzhf, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfhVar.zzc) {
            return false;
        }
        float[] fArr = zzfhVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        System.arraycopy(zzfhVar.zzb, 0, this.zzb, this.zzc, zzfhVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzfq<Float> zza(int i) {
        if (i < this.zzc) {
    ...
    static {
        zzfh zzfhVar = new zzfh(new float[0], 0);
        zza = zzfhVar;
        zzfhVar.h_();
    }
}
