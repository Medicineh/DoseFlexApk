...
class zzhn<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhs zzhsVarRemove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) zzhsVarRemove.getKey(), zzhsVarRemove.getValue());
        }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzhs(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int size = size();
        if (size != zzhnVar.size()) {
            return false;
        }
        int iZzc = zzc();
        if (iZzc != zzhnVar.zzc()) {
            return entrySet().equals(zzhnVar.entrySet());
        }
        for (int i = 0; i < iZzc; i++) {
            if (!zzb(i).equals(zzhnVar.zzb(i))) {
                return false;
            }
        }
        if (iZzc != size) {
            return this.zzc.equals(zzhnVar.zzc);
        }
        return true;
    }
    ...
    /* synthetic */ zzhn(int i, zzhm zzhmVar) {
        this(i);
    }
}
