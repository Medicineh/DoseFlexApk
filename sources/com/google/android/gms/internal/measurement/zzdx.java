...
final class zzdx extends zzdt<Boolean> implements zzfq<Boolean>, zzhf, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzdxVar.zzc) {
            return false;
        }
        boolean[] zArr = zzdxVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzfk.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        ...
        System.arraycopy(zzdxVar.zzb, 0, this.zzb, this.zzc, zzdxVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzfq<Boolean> zza(int i) {
        if (i < this.zzc) {
    ...
    static {
        zzdx zzdxVar = new zzdx(new boolean[0], 0);
        zza = zzdxVar;
        zzdxVar.h_();
    }
}
