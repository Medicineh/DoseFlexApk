...
interface zzix {
    ...
    void zza(int i, zzdz zzdzVar) throws IOException;

    <K, V> void zza(int i, zzgk<K, V> zzgkVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhi zzhiVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhi zzhiVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhi zzhiVar) throws IOException;

    void zzb(int i, List<zzdz> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhi zzhiVar) throws IOException;
