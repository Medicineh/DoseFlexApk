...
final class zzhw {
    static String zza(zzdz zzdzVar) {
        zzhz zzhzVar = new zzhz(zzdzVar);
        StringBuilder sb = new StringBuilder(zzhzVar.zza());
        for (int i = 0; i < zzhzVar.zza(); i++) {
            byte bZza = zzhzVar.zza(i);
            if (bZza == 34) {
                sb.append("\\\"");
            } else if (bZza == 39) {
                sb.append("\\'");
