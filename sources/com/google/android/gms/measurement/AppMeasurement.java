...
public class AppMeasurement {
    ...
    private static AppMeasurement zza(Context context, String str, String str2) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzhz zzhzVarZzb = zzb(context, null);
                    if (zzhzVarZzb != null) {
                        zza = new AppMeasurement(zzhzVarZzb);
                    } else {
    ...
    public static AppMeasurement zza(Context context, Bundle bundle) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzhz zzhzVarZzb = zzb(context, bundle);
                    if (zzhzVarZzb != null) {
                        zza = new AppMeasurement(zzhzVarZzb);
                    } else {
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        ...
        List<zzkn> listZzc = this.zzb.zzh().zzc(z);
        ArrayMap arrayMap = new ArrayMap(listZzc.size());
        for (zzkn zzknVar : listZzc) {
