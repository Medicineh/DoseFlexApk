...
final class zzes extends SQLiteOpenHelper {
    ...
    zzes(zzep zzepVar, Context context, String str) {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        zzaf.zza(this.zza.zzr(), sQLiteDatabase, "messages", "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", null);
    }
