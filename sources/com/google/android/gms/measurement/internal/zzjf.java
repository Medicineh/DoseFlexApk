...
public final class zzjf implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
            ...
            try {
                ...
                if ("com.google.android.gms.measurement.internal.IMeasurementService".equals(interfaceDescriptor)) {
                    if (iBinder != null) {
                        ...
                        if (iInterfaceQueryLocalInterface instanceof zzel) {
                            zzenVar = (zzel) iInterfaceQueryLocalInterface;
                        } else {
    ...
    public final void zzb() {
        ...
        synchronized (this) {
            ...
            this.zzc = new zzeu(contextZzn, Looper.getMainLooper(), this, this);
    ...
    public final void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        zzet zzetVarZzd = this.zza.zzz.zzd();
        if (zzetVarZzd != null) {
            zzetVarZzd.zzi().zza("Service connection failed", connectionResult);
        }
        synchronized (this) {
            this.zzb = false;
            this.zzc = null;
    ...
    static /* synthetic */ boolean zza(zzjf zzjfVar, boolean z) {
        zzjfVar.zzb = false;
        return false;
    }
}
