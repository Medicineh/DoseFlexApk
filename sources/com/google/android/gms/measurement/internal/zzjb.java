...
final class zzjb implements Runnable {
    ...
    zzjb(zzin zzinVar, AtomicReference atomicReference, String str, String str2, String str3, zzm zzmVar) {
        this.zzf = zzinVar;
        ...
        synchronized (this.zza) {
            try {
                ...
                if (TextUtils.isEmpty(this.zzb)) {
                    this.zza.set(zzelVar.zza(this.zzc, this.zzd, this.zze));
                } else {
                    this.zza.set(zzelVar.zza(this.zzb, this.zzc, this.zzd));
                }
                this.zzf.zzak();
                this.zza.notify();
            } finally {
