...
public final class zzfo {
    ...
    protected final void zza(String str) {
        ...
        zzfn zzfnVar = new zzfn(this, str);
        this.zza.zzq().zzd();
        ...
        if (listQueryIntentServices != null && !listQueryIntentServices.isEmpty()) {
            ...
            if (resolveInfo.serviceInfo != null) {
                ...
                if (resolveInfo.serviceInfo.name != null && "com.android.vending".equals(str2) && zza()) {
                    try {
                        this.zza.zzr().zzx().zza("Install Referrer Service is", ConnectionTracker.getInstance().bindService(this.zza.zzn(), new Intent(intent), zzfnVar, 1) ? "available" : "not available");
                        return;
                    } catch (Exception e) {
